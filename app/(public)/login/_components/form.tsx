...
export default function LoginForm() {
  ...
  return (
    <div className="w-full md:w-140 lg:w-100 2xl:w-132 py-10">
      <form
        action={formAction}
        className="flex flex-col gap-12 px-12 rounded-2xl"
      >
        <div className="flex justify-center items-center gap-4">
          <h1 className="font-extrabold text-4xl text-techtona-1">Login</h1>
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <Button
            size="lg"
            type="submit"
            className="bg-techtona-1 hover:bg-techtona-4 w-full text-md cursor-pointer"
          ...
          <h2 className="text-center text-sm">
            ...
            <Link href="/register" className="text-techtona-1 underline">
              Register
            </Link>
          </h2>
        </div>

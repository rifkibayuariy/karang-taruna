        ...
        <main>
            <div className="flex flex-col md:flex-row w-full justify-between md:pt-4">
                ...
                <div className="md:flex-1/3 flex justify-end pt-8 md:pt-0">
                    ...
                    <input
                        className="block peer h-full w-full rounded-xl py-3 pl-10 text-sm bg-white shadow-sm placeholder:text-gray-500 focus:outline-none"
                    />
                    <MagnifyingGlassIcon className="absolute left-3 top-1/2 size-5 -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
                    </div>
                </div>
            </div>

            ...
            >
              <div className="flex flex-row gap-2 items-center">
                <div className="flex flex-col gap-1 pl-2">
                  <span
                    className={`rounded-xl ${
                      cash.type == "income" ? "bg-green-500" : "bg-red-500"
                    } text-white font-bold px-1.5 py-0.25 text-xs w-fit`}
                  >
                    {cash.type == "income" ? "in" : "out"}
                  </span>
                  <span className="text-xs font-semibold">{cash.date}</span>
                </div>
                <div className="flex flex-col gap-0.5 pl-3 flex-auto">
                  <span className="text-sm font-semibold">
                    Rp. {cash.nominal}
                  </span>
                  <span className="text-xs">{cash.transaction}</span>
                </div>
                {["Iuran Uang Kas", "Uang Penerangan"].includes(
                  cash.transaction
                ) && (
                  <button
                    className="bg-green-500 rounded-lg p-1.5 text-white cursor-pointer"
                ...
                {!["Iuran Uang Kas", "Uang Penerangan"].includes(
                  ...
                  <>
                    <button
                      className="bg-gray-800 rounded-lg p-1.5 text-white cursor-pointer"
                      aria-label="Edit Cash"
                    >
                      <PencilSquareIcon className="size-4" />
                    </button>
                    <button
                      className="bg-red-600 rounded-lg p-1.5 text-white cursor-pointer"
                  ...
                  <td className="whitespace-nowrap px-4 py-3">
                    <div className="flex gap-1">
                      {!["Iuran Uang Kas", "Uang Penerangan"].includes(
                        ...
                        <>
                          <button
                            className="bg-gray-800 rounded-lg px-3 py-1.5 text-white cursor-pointer"
                            aria-label="Edit Cash"
                          >
                            <PencilSquareIcon className="size-4" />
                          </button>
                          <button
                            className="bg-red-600 rounded-lg px-3 py-1.5 text-white cursor-pointer"
                            aria-label="Delete Cash"
                          >
                            <TrashIcon className="size-4" />
                          </button>
                      ...
                      {["Iuran Uang Kas", "Uang Penerangan"].includes(
                        ...
                        <>
                          <button
                            className="bg-green-500 rounded-lg px-3 py-1.5 text-white cursor-pointer"
                            aria-label="View Cash"
                          >
                            <EyeIcon className="size-4" />
                          </button>
      ...
      <div className="pt-8 flex justify-center">
        <div className="bg-white rounded-xl shadow-sm flex flex-row gap-8 p-2">
          ...
          <div className="flex flex-row gap-1 text-sm justify-center items-center">
            <button className="w-7 h-7 bg-gray-800 rounded-md font-bold text-white">
              1
            </button>
          </div>
          <button className="flex items-center gap-1 text-xs text-gray-500 p-2">

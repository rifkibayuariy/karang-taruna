            ...
            <table className="min-w-full table">
                <thead className="rounded-lg text-left text-sm font-normal">
                    <tr className="border-b border-gray-200">
                        <th scope="col" className="px-4 pl-6 py-5 font-medium">Contribution Money</th>
                        <th scope="col" className="px-4 py-5 font-medium">Updated Date</th>
                    </tr>
                </thead>
                <tbody>
                    {contribution_money.map((contrib) => {
                        return (
                            ...
                            >
                                <td className="whitespace-nowrap px-4 pl-6 py-3">{contrib.contribution_money}</td>
                                <td className="whitespace-nowrap px-4 py-3">{contrib.updated_date}</td>
                            </tr>
                        )
                    })}
                </tbody>
